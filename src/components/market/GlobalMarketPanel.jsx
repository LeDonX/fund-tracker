...
import { Globe, RefreshCw, AlertCircle, TrendingUp, TrendingDown, Clock } from 'lucide-react';
  ...
  return (
    <div className="flex-1 flex flex-col md:grid md:grid-cols-12 gap-5 min-h-0 overflow-y-auto md:overflow-hidden pb-4 md:pb-0">
      ...
      <div className="col-span-1 md:col-span-7 flex flex-col gap-4 min-h-[300px] md:h-full md:overflow-hidden">
        ...
        <div className="flex items-center justify-between bg-white px-5 py-3 rounded-2xl border border-slate-200/50 shadow-xs shrink-0">
          <div className="flex items-center gap-2">
            <Globe className="w-4.5 h-4.5 text-blue-500 animate-spin-slow" />
            <h2 className="text-sm md:text-base font-black text-slate-800 tracking-tight">全球主流市场大盘</h2>
          </div>
          
          <div className="flex items-center gap-3">
            {lastUpdated && (
              <span className="flex items-center gap-1 text-[10px] md:text-[11px] font-bold text-slate-400 bg-slate-50 px-2.5 py-1 rounded-full border border-slate-200/30">
            ...
            <button
              ...
              className="flex items-center justify-center p-1.5 rounded-xl border border-slate-200 bg-white hover:bg-slate-50 active:scale-95 transition-all text-slate-500 cursor-pointer disabled:opacity-50"
              title="一键刷新行情"
            >
