...
function SidebarSparkline({ data, isPositive }) {
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col min-w-0 pr-1 select-none">
                  ...
                  <span className="text-[9px] font-bold text-slate-400 font-mono leading-none">
                    {sym}
                  </span>
                </div>
                ...
                <div className="flex flex-col items-end shrink-0 select-none">
                  <span className="text-11 font-black font-mono text-slate-700 leading-snug tracking-tight">
                    {data.currentPrice ? (sym === 'USDCNH=X' ? data.currentPrice.toFixed(4) : data.currentPrice.toFixed(2)) : '--'}
                  </span>
                  <span className={`inline-flex items-center justify-center font-mono font-extrabold text-[9.5px] px-1.5 py-0.5 rounded border leading-none scale-[0.95] origin-right mt-0.5 min-w-[50px] text-center ${rateColorClass}`}>
