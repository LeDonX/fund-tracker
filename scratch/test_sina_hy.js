async function run() {
  const url = 'http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodeData?node=sinahy&page=1&num=100&sort=changepercent&asc=0';
  ...
  try {
    ...
    try {
      ...
      console.log('JSON parse failed, trying to evaluate/clean...');
      try {
